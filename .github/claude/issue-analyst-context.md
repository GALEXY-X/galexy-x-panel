...
- Backend: Go 1.27, module `github.com/GALEXY-X/galexy-x-panel/v3`, Gin and GORM.
...
- **galexy-x/mtg-multi** — the MTProto sidecar whose TOML (`[secrets]`,
...
- Linux install: `bash <(curl -Ls https://raw.githubusercontent.com/GALEXY-X/galexy-x-panel/master/install.sh)`
...
- Docker image `ghcr.io/GALEXY-X/galexy-x-panel`; PostgreSQL profile
