...
const (
	panelUpdaterURL      = "https://raw.githubusercontent.com/GALEXY-X/galexy-x-panel/main/update.sh"
...
func fetchPanelRelease(tag string) (*service.Release, error) {
	url := "https://api.github.com/repos/GALEXY-X/galexy-x-panel/releases/latest"
	if tag != "" {
		url = "https://api.github.com/repos/GALEXY-X/galexy-x-panel/releases/tags/" + tag
	}
