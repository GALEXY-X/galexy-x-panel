...
import (
	...
	"github.com/GALEXY-X/galexy-x-panel/v3/internal/mtproto"
	"github.com/GALEXY-X/galexy-x-panel/v3/internal/tuic"
	"github.com/GALEXY-X/galexy-x-panel/v3/internal/util/common"
	"github.com/GALEXY-X/galexy-x-panel/v3/internal/util/sys"
	"github.com/GALEXY-X/galexy-x-panel/v3/internal/web/controller"
	"github.com/GALEXY-X/galexy-x-panel/v3/internal/web/job"
	"github.com/GALEXY-X/galexy-x-panel/v3/internal/web/locale"
	"github.com/GALEXY-X/galexy-x-panel/v3/internal/web/middleware"
	"github.com/GALEXY-X/galexy-x-panel/v3/internal/web/network"
	"github.com/GALEXY-X/galexy-x-panel/v3/internal/web/runtime"
	"github.com/GALEXY-X/galexy-x-panel/v3/internal/web/service"
	"github.com/GALEXY-X/galexy-x-panel/v3/internal/web/service/discord"
	"github.com/GALEXY-X/galexy-x-panel/v3/internal/web/service/email"
