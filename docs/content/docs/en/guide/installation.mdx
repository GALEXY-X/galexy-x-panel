...
[releases page](https://github.com/GALEXY-X/galexy-x-panel/releases), extract it, and run
...
The repo's [`deploy/`](https://github.com/GALEXY-X/galexy-x-panel/tree/main/deploy)
