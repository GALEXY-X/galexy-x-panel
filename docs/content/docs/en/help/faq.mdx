...
[GitHub](https://github.com/GALEXY-X/galexy-x-panel).
...
[releases page](https://github.com/GALEXY-X/galexy-x-panel/releases).
...
[GitHub](https://github.com/GALEXY-X/galexy-x-panel/issues). For common problems, start
