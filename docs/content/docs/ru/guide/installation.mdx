...
[страницы релизов](https://github.com/GALEXY-X/galexy-x-panel/releases), распаковать его и
...
В каталоге [`deploy/`](https://github.com/GALEXY-X/galexy-x-panel/tree/main/deploy)
