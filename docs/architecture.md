...
> tree rather than a pinned release (Go module `github.com/GALEXY-X/galexy-x-panel/v3`).
>
...
- **`mtg-multi` for MTProto inbounds** (`github.com/galexy-x/mtg-multi`, a multi-secret fork
...
- **Module path is `.../v3`.** Internal imports use `github.com/GALEXY-X/galexy-x-panel/v3/internal/...`.
